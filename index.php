    ...
    <div class="category">
        ...
        <div>
          <div id="skills-description">
              <h2>Obecne kierunki rozwoju</h2>
              <dl>
                <dt>Javascript</dt>
                  <dd>Płynne posługiwanie się w standardzie ES6, poznawanie specyficznych właściowści Javascriptu.</dd>
                <dt>Angular 5</dt>
                  <dd>Po topornym początku nauki zrozumiałem, jak wiele czasu framework od Google potrafi zaoszczędzić
                     porównując do pisania aplikacji 'od zera'. Teraz do każdej kolejnej lekcji podchodzę ze znacznie większą ekscytacją.</dd>
                <dt>SEO</dt>
                  <dd>Niezależnie od specjalizacji, każdy web developer powinien przynajmniej znać zasady odpowiedniej semantyki HTML
                     by nie rzuca sobię kłód pod nogi już na starcie projektu. Każda witryna chcę mieć rzeszę fanów dlatego optymalizacja
                      kontentu będzie zawsze wartościową umiejętnością.</dd>
                <dt>PHP</dt>
                  <dd>Mając w planach kilka ciekawych idei projektów do zrealizowania
                     oraz rozwój <a href="http://chessyes.eu">Chessyes.eu</a>
                      Niezbędnym jest dla mnie pisanie kodu od strony serwera.
                       To na pewno zrobi mnie też developerem bardziej kompletnym.</dd>
              </dl>
          </div>
        </div>
      ...
      <div class="projects">
                    <div class="project">
                                <div class="project-decription">
                                  ...
                                  <p><strong>ChessYes to witryna pozwalająca na rozwój umiejętności szachowych.</strong>   <br> <br>
                                    ...
                                    Baza zadań oraz partii stale jest powiększana. <br>
                  ...
                  <div class="project">
                                          <div class="project-decription">
                                               ...
                                               <p><strong> Catch up time to aplikacja, która ma za zadanie zwiększenie efektywności nauki/pracy poprzez pomoc w organizacji czasu.</strong> <br> <br>
                                               ...
                                               Dodatkowo, aplikacja jest wyposażona w podręczną, dynamiczną listę 'to do',
                                               która jest niezbędnym elementem każdego efektywnościowego świra! <br>
